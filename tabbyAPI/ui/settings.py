...
SAVER_FIELDS = (
    {
        ...
        "description": "KMS kiosk on a spare TTY. While LightDM is up it overlays that X session after the same idle timeout as a used console, and does not steal the TTY.",
        "kind": "bool",
        "optional": False,
        "default": True,
    },
    {
        ...
        "description": "Seconds without keyboard or mouse while logged in on the console, or while LightDM is showing, before the field returns.",
        "kind": "int",
        "optional": False,
        "default": 120,
    },
...
UPDATE_FIELDS = (
    {
        ...
        "description": "Pull the checked-out GitHub branch on a timer (main unless you switched). Skips while a chat or Comfy job is running.",
        "kind": "bool",
        "optional": False,
        "default": True,
    },
