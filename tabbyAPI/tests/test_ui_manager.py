...
class UiManagerTests(unittest.TestCase):
    ...
    def test_ui_access_lines_are_detected(self):
        ...
        self.assertTrue(manager.is_ui_access_line('"GET /v1/model HTTP/1.1" 200'))
        self.assertTrue(manager.is_ui_access_line('"GET /openai/v1/model HTTP/1.1" 200'))
        self.assertFalse(manager.is_ui_access_line('"GET /v1/models HTTP/1.1" 200'))
        self.assertFalse(manager.is_ui_access_line('"POST /v1/model/load HTTP/1.1" 200'))
